...
public class ArticleRepository {
    private List<Article> articleList = new ArrayList<>(){{
        ...
        add(new Article(1002,"Nano Nowhere", " new movies triler on days ","https://www.pexels.com/photo/1767434/download/",new AuthorRepository().getAllAuthor().get(1)));
        add(new Article(1003,"Koko ro", " new movies triler on days ","https://plus.unsplash.com/premium_photo-1669762659733-94b18d0803de?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8Y3V0ZSUyMHdhbGxwYXBlcnxlbnwwfHwwfHw%3D&w=1000&q=80",new AuthorRepository().getAllAuthor().get(2)));
        ...
        add(new Article(1005,"Yunaromi ", " new movies triler on days ","https://i.pinimg.com/564x/76/9a/60/769a60047076c61d72ed86fd318ba6a9.jpg",new AuthorRepository().getAllAuthor().get(4)));
    }};
